    ...
    <div className="w-full max-w-sm mx-auto space-y-6">
      ...
      <div className="flex justify-center">
        <button 
          ...
          className="flex items-center justify-center gap-3 w-full py-3 px-4 rounded-xl bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 transition-all group"
        ...
        >
          ...
          <span className="text-sm font-semibold text-zinc-300">Continue with Google</span>
        </button>
      </div>
