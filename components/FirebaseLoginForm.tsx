    ...
    <div className="w-full max-w-sm mx-auto space-y-6">
      ...
      <div className="grid grid-cols-3 gap-2">
        <button 
          ...
          className="flex items-center justify-center py-2.5 rounded-xl bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 transition-all group"
        ...
        <button 
          ...
          className="flex items-center justify-center py-2.5 rounded-xl bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 transition-all"
          title="Sign in with Apple"
        >
          <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24">
            <path d="M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-2.117 3.675-.546 9.103 1.519 12.09 1.013 1.454 2.208 3.09 3.792 3.039 1.52-.065 2.09-.987 3.935-.987 1.831 0 2.35.987 3.96.948 1.637-.026 2.671-1.48 3.671-2.948 1.158-1.688 1.636-3.325 1.662-3.415-.039-.013-3.182-1.221-3.22-4.857-.026-3.04 2.48-4.494 2.597-4.559-1.429-2.09-3.623-2.324-4.39-2.376-2-.156-3.675 1.09-4.61 1.09zM15.53 3.826c.844-1.026 1.4-2.442 1.248-3.826-1.183.052-2.613.793-3.458 1.78-.76.871-1.422 2.325-1.241 3.662 1.313.104 2.613-.597 3.451-1.616z"/>
          </svg>
        </button>
        <button 
